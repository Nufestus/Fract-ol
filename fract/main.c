...
/*   Updated: 2025/01/14 14:28:08 by aammisse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	handlemouse(int button, int x, int y, t_data *data)
{
	...
	mouse_re = (scale(x, -2, 2, WINDOW_WIDTH) * data->zoom) + data->shiftx;
	mouse_im = (scale(y, 2, -2, WINDOW_HEIGHT) * data->zoom) + data->shifty;
